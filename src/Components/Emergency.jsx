...
const EmergencyContacts = () => {
  return (
    <div className="bg-richblack-900" id='emergency'>
      {/* <Navbar /> */}
      <Container fluid className="emergency-contacts-container py-5 text-white">
        <h2 className='text-white' id='emergencyhead' >Emergency contacts</h2>
